...
import (
	...
	_ "github.com/hello2dj/ledisdb/store/goleveldb" // register goleveldb
	_ "github.com/hello2dj/ledisdb/store/leveldb"   // register leveldb
	_ "github.com/hello2dj/ledisdb/store/rocksdb"   // register rocksdb
)
